...
To create components you must use the `component` function from `core/template-parser/handlebar.js`

```js
import { component } from "/core/template-parser/handlebar.js";
